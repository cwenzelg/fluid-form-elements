 ...
 * @extends HTMLElement
 */
class FluidImgCropperElement extends PolymerElement
{
  static get template() {
    return html`
        <style>
        ...
        <div hidden\$="{{!preview}}">
            <div class="layout horizontal center-justified_">
                <img id="cropimgpreview" src\$="{{croppedImage}}" hidden\$="{{hideCroppedImage}}">
                <canvas id="cropCanvasPreview" hidden\$="{{!hideCroppedImage}}"></canvas>
            </div>
...
`;
  ...
  _init()
  {
      ...
      Polymer.Gestures.addListener(this.cropNode, 'down', (e, parent) => this._onDown(e, this));
      Polymer.Gestures.addListener(this.cropNode, 'track', (e, parent) => this._onTrack(e, this));
      Polymer.Gestures.addListener(this.cropNode, 'up', (e, parent) => this._onUp(e, this));
...
window.customElements.define(FluidImgCropperElement.is, FluidImgCropperElement);
